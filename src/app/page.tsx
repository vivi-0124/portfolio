...
export default function Home() {
  return (
    <div className="bg-background">
      ...
      {/* 自己紹介セクション */}
      <section id="about" className="bg-background py-16 px-4 mx-auto max-w-screen-xl lg:py-24 lg:px-6">
      ...
      {/* 主な作品セクション */}
      <section id="projects" className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-grid-white/[0.05] bg-[size:32px_32px]" />
          <div className="absolute h-full w-full bg-background [mask-image:radial-gradient(transparent,white)] opacity-25" />
        </div>
        <div className="relative py-12 px-4 mx-auto max-w-screen-xl lg:py-24 lg:px-6 z-10">
          <h2 className="text-3xl font-bold mb-2 text-center text-white">注目のプロジェクト</h2>
